...
const Footer = () => {
  return (
    <footer className="font-public bg-dark-blue  py-16 px-8  text-slate-50 flex flex-col  items-center text-center justify-center lg:flex lg:flex-row lg:text-left lg:gap-20 lg:px-16">
      <div className="flex flex-col items-center gap-10 lg:gap-0 lg:items-start">
        ...
        <div className=" mb-10 flex gap-6 lg:mt-9 lg:mb-0">
          <svg
            ...
            width="20"
            height="20"
            className="fill-white hover:fill-lime-green"
          >
      ...
      <ul>
        <li className="mt-3 hover:text-lime-green ">
          <a href="">About Us</a>
        </li>
        <li className="mt-3 hover:text-lime-green ">
          <a href=""> Contact </a>
      ...
      <div className=" mt-10 lg:ml-auto lg:self-right">
        <Button />
        <p className="text-grayish-blue  lg:mt-5 lg:text-left  mt-10">
